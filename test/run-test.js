...
test('built-in numeric pattern', t => {
  t.match(compile('numeric').test(1), true)
  t.match(compile('numeric').test(NaN), true)
  t.match(compile('numeric').test(Number.POSITIVE_INFINITY), true)
  t.match(compile('numeric').test(Number.NEGATIVE_INFINITY), true)
  t.match(compile('number').test(1), true)
  t.match(compile('number').test(NaN), false)
  t.match(compile('number').test(Number.POSITIVE_INFINITY), false)
  t.match(compile('number').test(Number.NEGATIVE_INFINITY), false)
  t.match(compile('finite').test(1), true)
  t.match(compile('finite').test(NaN), false)
  t.match(compile('finite').test(Number.POSITIVE_INFINITY), false)
  t.match(compile('finite').test(Number.NEGATIVE_INFINITY), false)
  t.match(compile('integer').test(1), true)
  t.match(compile('integer').test(1.0000001), false)
  t.match(compile('integer').test(NaN), false)
  t.match(compile('integer').test(Number.POSITIVE_INFINITY), false)
  t.match(compile('integer').test(Number.NEGATIVE_INFINITY), false)
  t.done()
})
