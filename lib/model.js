...
var Module = exports.Module = function () {
  ...
  _createClass(Module, [{
    ...
    key: 'addConst',
    value: function addConst(id, expr, exported) {}
  }]);
...
var ImportItem = exports.ImportItem = function ImportItem(origId, localId) {
...
var Object_ = exports.Object_ = function (_Expression6) {
  ...
  _createClass(Object_, [{
    ...
    value: function match(value) {
      ...
      try {
        for (var _iterator5 = Object.getOwnPropertyNames(value)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          try {
            for (var _iterator7 = this.properties[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
