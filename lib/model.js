  ...
  _createClass(ChainedCall, [{
    ...
    value: function match(value) {
      ...
      for (var _i = 0; _i < max; _i++) {
        value = this.calls[_i].eval(value);
      }
...
var Object = exports.Object = function (_Expression6) {
  _inherits(Object, _Expression6);

  function Object(properties) {
    _classCallCheck(this, Object);

    var _this6 = _possibleConstructorReturn(this, (Object.__proto__ || Object.getPrototypeOf(Object)).call(this));

    _this6.properties = properties;
    for (var _i2 = 0; _i2 < properties.length; _i2++) {
      properties[_i2].index = _i2;
    }
    return _this6;
  }
    ...
    value: function match(value) {
      ...
      try {
        for (var _iterator4 = this.properties[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          if (occ[i] < _prop.minCount || occ[i] > _prop.maxCount) {
            return false;
          }
        }
      } catch (err) {
...
var List = exports.List = function (_Expression7) {
  _inherits(List, _Expression7);

  function List(items) {
    _classCallCheck(this, List);

    var _this7 = _possibleConstructorReturn(this, (List.__proto__ || Object.getPrototypeOf(List)).call(this));
    ...
    value: function match(value) {
      ...
      try {
        for (var _iterator6 = this.items[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          ...
          var o = 0;
          while (o < _item.maxCount && vidx < value.length && _item.match(value[vidx++])) {
            o++;
          }
          if (o < _item.minCount) {
            return false;
